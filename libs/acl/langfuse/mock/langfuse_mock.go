...
//
//	mockgen -source=langfuse.go -destination=./mock/langfuse_mock.go -package=mock Langfuse
//
...
func (mr *MockLangfuseMockRecorder) CreateEvent(body any) *gomock.Call {
...
func (mr *MockLangfuseMockRecorder) CreateGeneration(body any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLangfuseMockRecorder) CreateSpan(body any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLangfuseMockRecorder) CreateTrace(body any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLangfuseMockRecorder) EndGeneration(body any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLangfuseMockRecorder) EndSpan(body any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockLangfuse) UpdateTrace(body *langfuse.TraceEventBody) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateTrace", body)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateTrace indicates an expected call of UpdateTrace.
func (mr *MockLangfuseMockRecorder) UpdateTrace(body any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateTrace", reflect.TypeOf((*MockLangfuse)(nil).UpdateTrace), body)
}
