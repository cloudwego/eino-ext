...
func (s *Scalar) Retrieve(ctx context.Context, client *milvusclient.Client, conf *RetrieverConfig, query string, opts ...retriever.Option) ([]*schema.Document, error) {
...
func (s *Scalar) BuildQueryOption(ctx context.Context, conf *RetrieverConfig, query string, opts ...retriever.Option) (milvusclient.QueryOption, error) {
