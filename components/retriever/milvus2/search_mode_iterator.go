...
func NewIterator(metricType MetricType, batchSize int) *Iterator {
	if batchSize <= 0 {
		batchSize = 100
	}
	return &Iterator{
...
func (i *Iterator) BuildSearchOption(ctx context.Context, conf *RetrieverConfig, queryVector []float32, opts ...retriever.Option) (milvusclient.SearchOption, error) {
...
func (i *Iterator) Retrieve(ctx context.Context, client *milvusclient.Client, conf *RetrieverConfig, query string, opts ...retriever.Option) ([]*schema.Document, error) {
...
func (i *Iterator) BuildSearchIteratorOption(ctx context.Context, conf *RetrieverConfig, queryVector []float32, opts ...retriever.Option) (milvusclient.SearchIteratorOption, error) {
