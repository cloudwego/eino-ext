...
// See: https://opensearch.org/docs/latest/query-dsl/specialized/neural-sparse/
func NeuralSparse(vectorField string, config *NeuralSparseConfig) opensearch.SearchMode {
	return &neuralSparse{
...
func (n *neuralSparse) BuildRequest(ctx context.Context, conf *opensearch.RetrieverConfig, query string,
	...
	io := retriever.GetImplSpecificOptions[opensearch.ImplOptions](nil, opts...)
