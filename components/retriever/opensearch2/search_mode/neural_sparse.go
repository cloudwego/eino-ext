...
// See: https://opensearch2.org/docs/latest/query-dsl/specialized/neural-sparse/
func NeuralSparse(vectorField string, config *NeuralSparseConfig) opensearch2.SearchMode {
	return &neuralSparse{
