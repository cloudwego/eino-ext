...
func ExactMatch(queryFieldName string) opensearch3.SearchMode {
...
func (e *exactMatch) BuildRequest(ctx context.Context, conf *opensearch3.RetrieverConfig, query string,
