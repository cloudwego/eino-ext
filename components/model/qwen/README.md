...
func main() {
	...
	For multi-modal output, such as when the qwen3-omni-flash model supports speech generation, you need to set Modalities and Audio when initializing the chat model:
