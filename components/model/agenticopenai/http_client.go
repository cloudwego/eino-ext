...
func getChatRequestTimeout(config *ChatConfig) time.Duration {
...
func getChatResponseHeaderTimeout(config *ChatConfig) time.Duration {
...
func getResponsesRequestTimeout(config *ResponsesConfig) *time.Duration {
