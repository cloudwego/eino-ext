...
// useful for Moonshot-specific parameters such as `partial` for prefix
// completion or `context_cache` for context caching.
// See https://platform.moonshot.cn/docs/api/partial and
