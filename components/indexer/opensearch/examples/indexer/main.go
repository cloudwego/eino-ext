...
func main() {
	...
	idx, err := opensearch.NewIndexer(ctx, &opensearch.IndexerConfig{
		Client: client,
		Index:  indexName,
		DocumentToFields: func(ctx context.Context, doc *schema.Document) (field2Value map[string]opensearch.FieldValue, err error) {
