...
require (
	...
	github.com/cloudwego/eino-ext/components/document/transformer/splitter/markdown v0.0.0-20251201051757-182503179fca
	github.com/cloudwego/eino-ext/components/embedding/openai v0.0.0-20251201051757-182503179fca
